          ...
          <div className="relative text-balance">
            <GridWrapper>
              ...
              <AnimatedText
                as="h3"
                delay={HEADING_DELAY}
                className="mx-auto max-w-2xl text-center text-lg font-medium tracking-tighter text-text-primary md:text-2xl md:leading-[32px]"
              >
                {/* Take a stroll through my digital world, you might find a spark for
                something we can build together.  */}
                Exploring the edge of Data Science and Generative AI to build scalable, real-world solutions.
                {/* I work across Data Science, Machine Learning, and Generative AI - turning complex ideas into practical, real-world solutions. */}
              </AnimatedText>
            </GridWrapper>
            <GridWrapper>
              <div className="mt-4 text-center md:mt-8">
                ...
                >
                  I&apos;m a Data Scientist, driven by curiosity and a passion for turning ideas into impactful solutions.
                  I focus on designing scalable models, optimizing workflows, and bringing innovative AI systems into real-world applications. 
                  My work spans data science, machine learning, and Gen AI - creating practical solutions and 
                  integrating them into real-world use. 
                  This site showcases my projects, experiments, and learnings along the way.
                </AnimatedText>
              </div>
            </GridWrapper>
          </div>
